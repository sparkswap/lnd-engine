...
LTCD_COMMIT_SHA=`git ls-remote git://github.com/ltcsuite/ltcd | grep 'refs/heads/master$' | cut -f 1`
BTCD_COMMIT_SHA=`git ls-remote git://github.com/btcsuite/btcd | grep 'refs/heads/master$' | cut -f 1`
